...
public:
    ...
    void setupUi(QWidget *SerialNumberUI)
    {
        ...
        SerialNumberUI->setStyleSheet(QStringLiteral("background-color: rgb(245, 245, 245);"));
        label = new QLabel(SerialNumberUI);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(370, 710, 101, 35));
        QFont font;
        ...
        lineEdit_serialNum->setGeometry(QRect(490, 710, 311, 37));
        QFont font1;
        ...
        label_2->setGeometry(QRect(820, 710, 261, 35));
        QFont font2;
        ...
        label_cameraFrame->setGeometry(QRect(390, 190, 668, 501));
        ...
        label_4->setGeometry(QRect(370, 150, 111, 35));
        ...
        label_background->setGeometry(QRect(310, 90, 821, 681));
        ...
        label_background_2 = new QLabel(SerialNumberUI);
        label_background_2->setObjectName(QStringLiteral("label_background_2"));
        label_background_2->setGeometry(QRect(0, 0, 1440, 900));
        label_background_2->setStyleSheet(QStringLiteral("border-image: url(:/PCBRecheck/icons/screen.png)"));
